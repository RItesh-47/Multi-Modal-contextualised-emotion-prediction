...
def save_checkpoint(model, best_fscore, best_loss, best_label, best_pred, best_mask, best_attn, filename):
...
def load_checkpoint(model, filename):
    ...
    return model, checkpoint['best_fscore'], checkpoint['best_loss'], checkpoint['best_label'], checkpoint['best_pred'], checkpoint['best_mask'], checkpoint['best_attn']
...
for e in range(n_epochs):
    ...
    if best_fscore == None or best_fscore < test_fscore:
        ...
        save_checkpoint(model, best_fscore, best_loss, best_label, best_pred, best_mask, best_attn, 'best_model_meld.pt')
#     if args.tensorboard:
